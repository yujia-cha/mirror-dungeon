...
export const STRINGS = {
  ...
  skillsBucketBuff: { ko: '버프', en: 'Buffs' },
  skillsTagsEffect: { ko: '걸리는 방식', en: 'How it applies' },
  skillsTagsBucket: { ko: '계열', en: 'Kind' },
  skillsClearTags: { ko: '태그 지우기', en: 'Clear tags' },
  skillsNoneTagged: { ko: '고른 태그에 해당하는 기프트가 없습니다', en: 'No gift carries the tags you picked' },
  skillsBucketDebuff: { ko: '디버프', en: 'Debuffs' },
